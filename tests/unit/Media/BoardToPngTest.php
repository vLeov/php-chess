...
class BoardToPngTest extends AbstractUnitTestCase
{
    ...
    public function output_start()
    {
        ...
        $this->assertSame(
            ...
            filesize(self::DATA_FOLDER.'/img/start.png')
        );
    }
    ...
    public function output_01_kaufman()
    {
        ...
        $this->assertSame(
            filesize(self::OUTPUT_FOLDER.'/'.$filename),
            filesize(self::DATA_FOLDER.'/img/01_kaufman.png')
        );
    }
    ...
    public function output_01_kaufman_flip()
    {
        ...
        $this->assertSame(
            filesize(self::OUTPUT_FOLDER.'/'.$filename),
            filesize(self::DATA_FOLDER.'/img/01_kaufman_flip.png')
        );
    }
    ...
    public function output_02_kaufman()
    {
        ...
        $this->assertSame(
            filesize(self::OUTPUT_FOLDER.'/'.$filename),
            filesize(self::DATA_FOLDER.'/img/02_kaufman.png')
        );
    }
    ...
    public function output_A59()
    {
        ...
        $this->assertSame(
            filesize(self::OUTPUT_FOLDER.'/'.$filename),
            filesize(self::DATA_FOLDER.'/img/A59.png')
        );
    }
    ...
    public function output_A59_flip()
    {
        ...
        $this->assertSame(
            filesize(self::OUTPUT_FOLDER.'/'.$filename),
            filesize(self::DATA_FOLDER.'/img/A59_flip.png')
        );
    }
    ...
    public function output_D06()
    {
        ...
        $this->assertSame(
            filesize(self::OUTPUT_FOLDER.'/'.$filename),
            filesize(self::DATA_FOLDER.'/img/symmetrical_defense_to_the_queens_gambit.png')
        );
    }
    ...
    public function output_D06_flip()
    {
        ...
        $this->assertSame(
            filesize(self::OUTPUT_FOLDER.'/'.$filename),
            filesize(self::DATA_FOLDER.'/img/symmetrical_defense_to_the_queens_gambit_flip.png')
        );
    }
    ...
    public function output_start_capablanca100()
    {
        ...
        $this->assertSame(
            filesize(self::OUTPUT_FOLDER.'/'.$filename),
            filesize(self::DATA_FOLDER.'/img/start_capablanca100.png')
        );
    }
    ...
    public function output_start_capablanca80()
    {
        ...
        $this->assertSame(
            filesize(self::OUTPUT_FOLDER.'/'.$filename),
            filesize(self::DATA_FOLDER.'/img/start_capablanca80.png')
        );
    }
    ...
    public function output_capablanca80_Nj3_e5___Ci6_O_O()
    {
        ...
        $this->assertSame(
            filesize(self::OUTPUT_FOLDER.'/'.$filename),
            filesize(self::DATA_FOLDER.'/img/Nj3_e5___capablanca80.png')
        );
    }
    ...
    public function output_capablanca100_a4_j7___bxc10_ixj1()
    {
        ...
        $this->assertSame(
            filesize(self::OUTPUT_FOLDER.'/'.$filename),
            filesize(self::DATA_FOLDER.'/img/a4_j7___capablanca100.png')
        );
    }
}
