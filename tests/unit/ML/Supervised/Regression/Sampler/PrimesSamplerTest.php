...
class PrimesSamplerTest extends AbstractUnitTestCase
{
    ...
    public function w_e4_b_Na6()
    {
        ...
        $expected = [
            Symbol::WHITE => [0, 0.5, 0, 1, 0, 1, 1],
            Symbol::BLACK => [1, 0.5, 1, 0, 1, 0, 0],
        ];
    ...
    public function w_e4_b_Nc6()
    {
        ...
        $expected = [
            Symbol::WHITE => [0, 0.5, 0.5, 0.5, 0, 1, 0.5],
            Symbol::BLACK => [1, 0.5, 0.5, 0.5, 1, 0, 0.5],
        ];
    ...
    public function scholar_checkmate()
    {
        ...
        $expected = [
            Symbol::WHITE => [1, 1, 0.4, 0, 0.07, 0.8, 1],
            Symbol::BLACK => [0, 0, 1, 1, 0.93, 0.4, 0.4],
        ];
