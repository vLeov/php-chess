...
class SamplerTest extends AbstractUnitTestCase
{
    ...
    public function start()
    {
        ...
        $expected = [
            Symbol::WHITE => [0.5, 0.5, 0.5, 0.5, 0.5],
            Symbol::BLACK => [0.5, 0.5, 0.5, 0.5, 0.5],
        ];
    ...
    public function w_e4_b_Na6()
    {
        ...
        $expected = [
            Symbol::WHITE => [1, 0, 1, 0.5, 0],
            Symbol::BLACK => [0, 1, 0, 0.5, 1],
        ];
    ...
    public function w_e4_b_Nc6()
    {
        ...
        $expected = [
            Symbol::WHITE => [0.5, 0, 0.5, 0.5, 0],
            Symbol::BLACK => [0.5, 1, 0.5, 0.5, 1],
        ];
    ...
    public function w_e4_b_e5_w_Nf3_Nc6()
    {
        ...
        $expected = [
            Symbol::WHITE => [1, 1, 1, 0.25, 1],
            Symbol::BLACK => [0, 0.5, 0, 0.25, 1],
        ];
    ...
    public function fool_checkmate()
    {
        ...
        $expected = [
            Symbol::WHITE => [0, 1, 0, 0, 0],
            Symbol::BLACK => [1, 0, 1, 1, 1],
        ];
    ...
    public function scholar_checkmate()
    {
        ...
        $expected = [
            Symbol::WHITE => [1, 0.07, 0, 1, 1],
            Symbol::BLACK => [0.4, 0.93, 1, 0, 0],
        ];
    ...
    public function benko_gambit()
    {
        ...
        $expected = [
            Symbol::WHITE => [0, 0.15, 1, 1, 0.19],
            Symbol::BLACK => [0.75, 0.46, 0, 1, 0],
        ];
    ...
    public function closed_sicilian()
    {
        ...
        $expected = [
            Symbol::WHITE => [0, 0.11, 1, 0.1, 0],
            Symbol::BLACK => [1, 0.89, 0.24, 0.1, 0],
        ];
