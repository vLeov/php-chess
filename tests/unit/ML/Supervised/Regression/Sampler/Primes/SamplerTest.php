...
class SamplerTest extends AbstractUnitTestCase
{
    ...
    public function start()
    {
        ...
        $expected = [
            Symbol::WHITE => [0, 37, 0, 1, 40.06, 0],
            Symbol::BLACK => [0, 37, 0, 1, 40.06, 0],
        ];
    ...
    public function fool_checkmate()
    {
        ...
        $expected = [
            Symbol::WHITE => [0, 40, 1, 0, 40.06, 0],
            Symbol::BLACK => [3, 24, 2, 1, 40.06, 1],
        ];
    ...
    public function scholar_checkmate()
    {
        ...
        $expected = [
            Symbol::WHITE => [5, 22, 2, 1, 40.06, 1],
            Symbol::BLACK => [2, 35, 3, -3, 39.06, 0],
        ];
    ...
    public function benko_gambit()
    {
        ...
        $expected = [
            Symbol::WHITE => [0, 29, 3, 1, 35.73, 0],
            Symbol::BLACK => [3, 33, 2, 1, 34.73, 0],
        ];
    ...
    public function closed_sicilian()
    {
        ...
        $expected = [
            Symbol::WHITE => [0, 29, 5.2, 1, 39.06, 0],
            Symbol::BLACK => [1, 36, 2, 1, 39.06, 0],
        ];
