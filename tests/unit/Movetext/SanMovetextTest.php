...
class SanMovetextTest extends AbstractUnitTestCase
{
    ...
    public function get_first_e4_e5__Nd5()
    {
        ...
        $this->assertSame($expected, (new SanMovetext(self::$move, $movetext))->getFirst());
    }
    ...
    public function get_last_e4_e5__Nd5()
    {
        ...
        $this->assertSame($expected, (new SanMovetext(self::$move, $movetext))->getLast());
    }
     ...
     * @test
     */
    public function get_end_turn_Kb8()
    {
        $movetext = '6...Kb8';

        $expected = 'b';

        $this->assertSame($expected, (new SanMovetext(self::$move, $movetext))->getEndTurn());
    }
     ...
     * @test
     */
    public function get_end_turn_Rh5()
    {
        $movetext = '3.Rh5';
     ...
     * @test
     */
    public function get_end_turn_e4_e5__Nd5()
    {
        $movetext = '1.e4 e5 2.Nf3 Nc6 3.Bb5 Nf6 4.Nc3 Be7 5.d3 d6 6.Be3 Bd7 7.Qd2 a6 8.Ba4 b5 9.Bb3 O-O 10.O-O-O b4 11.Nd5';
     ...
     * @test
     */
    public function get_end_turn_a5__Nxg4()
    {
        $movetext = '12...a5 13.g4 Nxg4';
     ...
     * @test
     */
    public function get_turn_a5__Nxg4()
    {
        $movetext = '12...a5 13.g4 Nxg4';
