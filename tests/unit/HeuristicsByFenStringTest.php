...
class HeuristicsByFenStringTest extends AbstractUnitTestCase
{
    ...
    */
    ...
    public function get_resized_balance_e4_e5()
    {
        ...
        $expected = [ 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5 ];
    ...
    public function get_resized_balance_benko_gambit()
    {
        ...
        $expected = [ 0.51, 0.61, 0.49, 0.55, 0.47, 0.5, 0.5, 0.5, 0.5, 0.53, 0.5, 0.49, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5 ];
    ...
    */
    ...
    public function get_result_benko_gambit()
    {
        ...
        $expected = [
            'w' => [ 0.88, 1, 0.45, 0.59, 0, 0.02, 0, 0, 0, 0.05, 0, 0, 0, 0, 0, 0, 0.02, 0, 0 ],
            'b' => [ 0.86, 0.78, 0.47, 0.5, 0.07, 0.02, 0, 0, 0, 0, 0, 0.02, 0, 0, 0, 0, 0.02, 0, 0 ],
        ];
