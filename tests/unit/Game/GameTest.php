    ...
    public function check_status()
    {
        ...
        $status = (object) [
            ...
            'squares' => (object) [
                'used' => (object) [
                    'w' => [
                        'a1', 'd1', 'e1', 'f1', 'g1', 'h1', 'a2', 'b2',
                        'c2','e2', 'f2', 'g2', 'h2', 'd4', 'c3',
                    ],
                    'b' => [
                        'c8', 'd8', 'e8', 'f8', 'h8', 'a7', 'b7', 'e7',
                        'f7', 'g7', 'h7', 'c6', 'd5', 'f6', 'b8',
                    ]
                ],
                'free' => [
                    'a3', 'a4', 'a5', 'a6', 'a8', 'b1', 'b3', 'b4',
                    'b5', 'b6', 'c1', 'c4', 'c5', 'c7', 'd2', 'd3',
                    'd6', 'd7', 'e3', 'e4', 'e5', 'e6', 'f3', 'f4',
                    'f5', 'g3', 'g4', 'g5', 'g6', 'g8', 'h3', 'h4',
                    'h5', 'h6',
                ]
            ],
            'attack' => (object) [
            ...
            'space' => (object) [
                'w' => [
                    'a3', 'a4', 'b1', 'b3', 'b5', 'c1', 'c5', 'd2',
                    'd3', 'e3', 'e4', 'e5', 'f3', 'g3', 'h3',
                ],
                'b' => [
                    'a5', 'a6', 'a8', 'b5', 'b6', 'c4', 'c7', 'd6',
                    'd7', 'e4', 'e6', 'f5', 'g4', 'g6', 'g8', 'h3',
                    'h5', 'h6',
                ]
            ],
            'castling' => [
        ...
        // white's control
        $this->assertEquals($status->space->w, $this->game->status()->space->{'w'});
        $this->assertEquals($status->attack->w, $this->game->status()->attack->{'w'});

        // black's control
        $this->assertEquals($status->space->b, $this->game->status()->space->{'b'});
